...
import { getFeaturesSection, getFeatureCards, getStrapiImageUrl } from '@/app/lib/strapi';
          ...
          <div className="lg:hidden">
            <div className="relative overflow-hidden">
              ...
              >
                ...
                >
                  {state.featureCards.map((feature, index) => (
                    <div
                      key={feature.id}
                      className={`flex-shrink-0 px-2 transition-all duration-300 ${index === activeSlide ? 'opacity-100 scale-100' : 'opacity-60 scale-95'
                        }`}
                      style={{ width: '75%' }}
                    >
                      <FeatureCard
