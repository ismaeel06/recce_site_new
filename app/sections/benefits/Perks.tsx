...
import PerksCard from "@/app/components/benefits/PerksCard";
import { getPerksHeader, getPerks } from "@/app/lib/strapi";
            ...
            >
              ...
              >
                {perks.map((perk, index) => (
                  <div
                    key={index}
                    className={`flex-shrink-0 px-4 sm:px-6 md:px-4 flex justify-center transition-all duration-300 ${index === activeIndex ? 'opacity-100 scale-100' : 'opacity-60 scale-95'
                      }`}
                    style={{ width: '75%' }}
                  >
