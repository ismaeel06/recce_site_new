...
import { getTermsAndConditions } from "@/app/lib/strapi";
...
export default function TermsAndConditions() {
  const [data, setData] = useState<TermsAndConditionsData | null>(null);
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="space-y-8 md:space-y-12">
            {data?.sections && data.sections.length > 0 ? (
              ...
              <div className="text-white/60">No terms content available</div>
            )}
          </div>
