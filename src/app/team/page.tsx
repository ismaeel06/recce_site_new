  ...
  const teamMembers = [
    {
      ...
      title: "Founder & CEO",
      description:
        'A lifelong cinephile who believes the perfect recommendation can change your day. Started Recce to end "what to watch" debates for good.',
      you: false,
    },
    {
      name: "Ben Carter",
      ...
      description:
        "Obsessed with building an app that's both powerful and intuitively simple.He's the reason our filters are so satisfying.",
      you: false,
    },
    {
      name: "Leo Martinez",
      title: "Lead Engineer",
      description:
        'The architect behind our platform. He turns complex ideas and endless streams of caffeine into a seamless user experience.',
      you: false,
    },
    {
      name: "Sophie Chen",
      ...
      description:
        "The heart of Recce. She's our number one user champion, curator of good vibes, and host of our Auteur Club events.",
      you: false,
    },
    {
      name: "Aisha Patel",
      ...
      description:
        'The visual storyteller who ensures Recce not only works great but looks and feels beautiful. Every pixel has a purpose.',
      you: false,
    },
    {
      name: "David Miller",
      ...
      description:
        "Spreads the word about Recce. If you've seen us on social media or read our newsletter, that's David's work.",
      you: false,
    },
    {
      name: "Kenji Tanaka",
      ...
      description:
        'Uncovers the trends and insights that help us improve our recommendation systems and reward our top contributors fairly.',
      you: false,
    },
    {
      name: "Join Our Team",
      ...
      description:
        "Love movies, TV, and building great products? We're always looking for talented people.Check our open positions.",
      you: true,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 flex flex-col justify-center items-center">
            <h1 className="text-[26px] md:text-[60px] font-medium mb-6 md:w-[800px] text-center">
              The people behind the <span className="text-[#ff7802]">Picks</span>
            </h1>
            <p className="text-base md:text-xl text-white/60 md:max-w-5xl mx-auto text-center">
              We're a collective of film buffs, tech enthusiasts, and design nerds united by a single mission: to cure
              content overload. We believe that the best recommendations come from people, not algorithms. Our values are
              rooted in authenticity, community, and a genuine passion for storytelling.
            </p>
          </div>
        </div>
