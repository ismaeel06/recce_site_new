      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-16">
          <div className="relative flex justify-center items-center z-10">
            <div className="w-64 h-96 bg-gray-800 rounded-3xl border-8 border-gray-700 overflow-hidden flex items-center justify-center shadow-2xl">
        ...
        <div className="mt-32 bg-gray-800 rounded-3xl p-6 md:p-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-0 w-full md:w-auto border border-gray-600 rounded-xl overflow-hidden">
              <input 
                type="email" 
                placeholder="Enter your email" 
                className="flex-1 px-3 md:px-4 py-2 md:py-3 bg-gray-700 text-white placeholder-gray-400 focus:outline-none text-sm"
              />
              <button className="px-1 md:px-8 py-2 md:py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold transition-colors whitespace-nowrap text-sm md:text-base">
                Subscribe
              </button>
            </div>
          </div>
